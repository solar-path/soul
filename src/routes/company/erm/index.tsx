...
export const Route = createFileRoute("/company/erm/")({
  ...
  beforeLoad: async ({ context }): Promise<ErmLoaderData> => {
    try {
      ...
      console.error("Error in ERM route protection:", error);
      throw error;
    }
  },
});
...
function RouteComponent() {
  ...
  return (
    <QAuthGuard requireVerified={true}>
      <div className="p-4">
        <h1 className="text-2xl font-bold mb-4">Enterprise Risk Management</h1>
        <p>

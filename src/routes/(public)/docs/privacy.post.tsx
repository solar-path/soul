...
function RouteComponent() {
  return (
    <div className="flex flex-col space-y-2 text-justify p-8">
      ...
      <p>Aneko Last Updated: April 18, 2024</p>
      <p className="mb-2 text-lg font-semibold">Introduction</p>
      <p className="text-justify">
        Aneko (“Company” or “we” or “us”) respects your privacy and is committed
        to protecting it through our compliance with this policy. The term
        "Aneko" refers to Aneko, LLC doing business under the name “Aneko”.
      </p>
      <p className="text-justify">
        This policy describes the types of information we may collect from you
        or that you may provide when you visit the website{" "}
        <a href="/">aneko.io</a> including products, features, materials, and
        services we offer (collectively, the “Website”) and our practices for
      ...
      <ul className="text-justify list-disc ml-8">
        ...
        <li>
          ...
          you and this Website. When you interact with our advertising and
      ...
      <p className="text-justify">
        ...
        practices regarding your information and how we treat it. If you do not
      ...
      <p className="mb-2 text-lg font-semibold">Children Under the Age of 18</p>
      <p className="text-justify">
        No one under the age of eighteen (18) may provide any personal
        information to or on the Website without verifiable parental consent.
        Please note that we do not knowingly collect any personally identifiable
        information from children under the age of eighteen (18) without
        obtaining verifiable consent from that child’s parent or guardian
        (“Parental Consent”), except for the limited amount of personally
        identifiable information we need to collect in order to obtain Parental
        Consent (“Required Information”). Until we have received Parental
        Consent, we will only use Required Information for the purpose of
        obtaining Parental Consent. If you are a child under the age of eighteen
        (18), please do not attempt to use or register for the Website or send
        any personal information about yourself to us before we obtain Parental
        Consent, except for the Required Information for purposes of the
        Parental Consent process. If you are a parent or legal guardian and
        think that your child under the age of eighteen (18) has given us
      ...
      <ul className="text-justify list-disc ml-8">
        <li>
          ...
          e-mail address, industry, workplace company, field of work, telephone
          number, or any other identifier by which a user may be contacted
          online or offline, and credit card number or other payment information
          (via our third-party payment processor that we currently use)
      ...
      <p className="text-justify">We collect this information:</p>
      <ul className="text-justify list-disc ml-8">
      ...
      <ul className="text-justify list-disc ml-8">
        <li>
          ...
          Website, subscribing to our service, posting material, interactive
          comments or chats with other Users and visible to public visitors of
          the Website, or requesting further services. We may also ask you for
      ...
      <p className="text-justify">
        ...
        (hereinafter, “posted”) on public areas of the Website or transmitted to
        ...
        to others at your own risk. Although you may set certain privacy
      ...
      <ul className="text-justify list-disc ml-8">
        <li>
          Details of your visits to our Website, including communication data
